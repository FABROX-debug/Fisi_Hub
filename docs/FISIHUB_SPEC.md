# FISIHUB — Especificación Maestra del Proyecto

> **Archivo:** `docs/FISIHUB_SPEC.md`  
> **Origen:** Copia limpia del documento original `docs/se ha pegado en el markdown.md`  
> **Versión:** 1.0 — No modificar sin consenso del equipo.  
> Este archivo es la referencia principal para todos los sprints del MVP.  
> Codex debe leer este archivo antes de implementar cualquier funcionalidad.
